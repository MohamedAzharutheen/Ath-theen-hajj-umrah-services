...
export default function Transportation() {
   ...
   const transport =[
    {
        icon:<SiRailway  size={50} color='#b49164'/>,
        heading:"Haramain High-Speed Railway"
    },
    {
        icon: <MdFlightTakeoff size={50} color='#b49164'/>,
        heading:"Haramain High-Speed Railway"
    },
    {
        icon:<FaBusAlt size={50} color='#b49164'/>,
        heading:"Haramain High-Speed Railway"
    }
    ,
    {
        icon:<FaCar size={50} color='#b49164'/>,
        heading:"Haramain High-Speed Railway"
    }
  ...
  return (
    ...
    <section className='container-fluid'>
        ...
        <p className='fs18 lnh33 ls05 mfs-16 cw pdt16'>{items}</p>
        ...
        <div className='mt20 df fjse fw '>
            {transport.map((items,index)=>{
                return(
         <div className='df fdc fac mt-4 mt-lg0'> 

        <span> {items.icon} </span>  
        <p className='fs-16 mfs-16 cw pt-4'>{items.heading}</p>
        </div>
        )
    })}
        </div>
